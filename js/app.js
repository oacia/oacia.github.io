var CONFIG = {"version":"0.2.5","hostname":"https://oacia.dev","root":"/","statics":"/","favicon":{"normal":"images/favicon.ico","hidden":"images/failure.ico"},"darkmode":false,"auto_scroll":false,"js":{"valine":"js/valine/MiniValine.min.js","chart":"npm/frappe-charts@1.5.0/dist/frappe-charts.min.iife.min.js","copy_tex":"npm/katex@0.12.0/dist/contrib/copy-tex.min.js","fancybox":"combine/npm/jquery@3.5.1/dist/jquery.min.js,npm/@fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.js,npm/justifiedGallery@3.8.1/dist/js/jquery.justifiedGallery.min.js"},"css":{"valine":"css/comment.css","katex":"npm/katex@0.12.0/dist/katex.min.css","mermaid":"css/mermaid.css","fancybox":"combine/npm/@fancyapps/fancybox@3.5.7/dist/jquery.fancybox.min.css,npm/justifiedGallery@3.8.1/dist/css/justifiedGallery.min.css"},"loader":{"start":true,"switch":false},"search":{"appID":"82XJEUJV1F","apiKey":"b575294975c5966c188b2dbbd13c9125","indexName":"shoka","hits":{"per_page":10}},"valine":{"appId":"0hYl0JdeTkmxIPvUZllH3SnZ-gzGzoHsz","appKey":"eXAuQtCMZkJ3h6EI0i4atSSv","placeholder":"真希望有人评论呢，说点什么吧~","avatar":"mp","pageSize":10,"lang":"zh-CN","visitor":true,"NoRecordIP":false,"serverURLs":null,"powerMode":true,"enableQQ":true,"tagMeta":{"visitor":"新朋友","master":"sensei","friend":"小伙伴","investor":"金主"},"tagColor":{"master":"var(--color-orange)","friend":"var(--color-pink)","investor":"var(--color-aqua)"},"tagMember":{"master":["1df312472bd41ac5515eff320cae86fc"],"friend":["7fb16ca358e89485d2811c03341eab26","fcd434850c8e0d9b61c64c2c187418f2","e8189325abd9b8950689b0bbb6c75a9c","ccafe903044a533585f0f607d627b3ae","0d0c46bc0e85721a045c0818d104c1d3"],"investor":null}},"quicklink":{"timeout":3000,"priority":true},"fireworks":["rgba(255,182,185,.9)","rgba(250,227,217,.9)","rgba(187,222,214,.9)","rgba(138,198,209,.9)"]};const getRndInteger = function (min, max) {
...
window.onload = function(){
  setTimeout(()=>{
    ...
    console.table({
      ...
      'loadingtime': (t.loadEventEnd - t.navigationStart).toFixed(0)
    })
  })
}
...
const postBeauty = function () {
  ...
  $('.post.block').oncopy = function(event) {
    ...
    var total_len = window.getSelection().toString().length
    var chinese = window.getSelection().toString().match(/[\u4e00-\u9fa5]/g)
    var chinese_len = chinese?chinese.length:0;
    if(total_len-chinese_len < chinese_len && chinese_len > 30 && copyright) {
      event.preventDefault();
  ...
  $.each('figure.highlight', function (element) {
    ...
    if(LOCAL.nocopy) {
      ...
      copyBtn.addEventListener('mouseout', function (event) {
    ...
    breakBtn.addEventListener('mouseover', function (event) {
      if(event.currentTarget.child('.ic').className == 'ic i-align-left'){
        breakBtn.setAttribute("title", "换行");
      }
      else if(event.currentTarget.child('.ic').className == 'ic i-align-justify'){
        breakBtn.setAttribute("title", "不换行");
      }
      
    });
    breakBtn.addEventListener('mouseout', function (event) {
      breakBtn.removeAttribute("title");
    });
    ...
    var fullscreenHandle = function(event) {
      ...
      if (element.hasClass('fullscreen')) {
        remove_fs_handle();
        window.removeEventListener("popstate",remove_fs_handle);
      } else {
        element.addClass('fullscreen');
        BODY.addClass('fullscreen');
        fullscreenBtn.child('.ic').className = 'ic i-compress';
        showCode && showCode();
        window.addEventListener("popstate", remove_fs_handle, false);
      }
    }
    fullscreenBtn.addEventListener('click', fullscreenHandle);
    caption && caption.addEventListener('click', fullscreenHandle);
    fullscreenBtn.addEventListener('mouseover', function (event) {
      if(event.currentTarget.child('.ic').className == 'ic i-expand'){
        fullscreenBtn.setAttribute("title", "全屏");
      }
      else if(event.currentTarget.child('.ic').className == 'ic i-compress'){
        fullscreenBtn.setAttribute("title", "退出全屏");
      }
      
    });
    fullscreenBtn.addEventListener('mouseout', function (event) {
      fullscreenBtn.removeAttribute("title");
    });

    //显示更多代码行数的按钮
    if(code_container && code_container.find("tr").length > 15) {
      
      code_container.style.maxHeight = "400px";
